...
export default function CustomerRoomInfoScreen() {
    ...
    const getLocalizedRoomField = useCallback(
        (baseKey, fallback) => {
            ...
            if (lang === 'en') return sectionData[`${baseKey}En`] || sectionData[baseKey] || fallback;
            if (lang === 'jp') return sectionData[`${baseKey}Jp`] || sectionData[baseKey] || fallback;
...
function HotelGalleryPlaceholder() {
    return (
        <View style={styles.galleryPlaceholderRow}>
            <View style={[styles.galleryPlaceholderBlock, styles.galleryPlaceholderLeft]} />
            <View style={styles.galleryPlaceholderRightCol}>
                <View style={[styles.galleryPlaceholderBlock, styles.galleryPlaceholderRight]} />
            </View>
        </View>
    );
}
